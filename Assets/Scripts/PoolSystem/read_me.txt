...
and calling the method Spawn passing both tags, category and pool, an object of that pool will be spawned/pooled without considering the spawn probability of the pool. 
...
on the spawn probability of the pool and then one of the pooled object of that pool is spawned and returned.
